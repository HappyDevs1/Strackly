...
import NewProductSuccess from "../screens/NewProductSuccess";
import UpdateStockSuccess from "../screens/UpdateStockSuccess";
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator>
        ...
        />
        <Stack.Screen
          name="UpdateStockSuccess"
          component={UpdateStockSuccess}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="NewProduct"
